const paths = {
  'arrow-right': '<path d="M5 12h14M13 6l6 6-6 6"/>', 'arrow-right-long': '<path d="M3 12h18M15 6l6 6-6 6"/>', bars: '<path d="M4 6h16M4 12h16M4 18h16"/>', clock: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>',
