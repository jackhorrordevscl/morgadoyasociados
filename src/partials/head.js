const { site, organizationJsonLd, serviceJsonLd, breadcrumbJsonLd, escapeHtmlAttribute } = require('../data/site');
...
function breadcrumbSchema(page) {
  return `<script type="application/ld+json">\n${JSON.stringify(breadcrumbJsonLd(page.canonical, page.breadcrumbLabel), null, 2)}\n</script>`;
}
