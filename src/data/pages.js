...
const pages = [
  ...
  definePage({ slug: 'contact', filename: 'contact.html', bodyData: 'contact', activeNav: 'contact', contactCta: '#contact-form', titleSuffix: 'Contacto', description: 'Agende una consulta inicial con Asesoría Legal Morgado, Cía. & Asociados.', jsonLd: true, optionalScript: 'assets/contact.js' }),
